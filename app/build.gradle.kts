...
android {
    ...
    defaultConfig {
        applicationId = "com.vinzz.vinzzrender"
        minSdk = 26
        targetSdk = 36
        versionCode = 100
        versionName = "1.0.0"
    ...
    buildTypes {
        ...
        configureEach {
            resValue("string","app_name","VinzzRenderer")

            manifestPlaceholders["des"] = "VinzzRenderer (OpenGL 4.0, 1.17+)"
            manifestPlaceholders["renderer"] = "VinzzRenderer:libmobileglues.so:libmobileglues.so"
